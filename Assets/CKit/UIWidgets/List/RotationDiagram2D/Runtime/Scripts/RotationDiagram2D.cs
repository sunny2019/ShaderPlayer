...
namespace CKit
{
    ...
    {
        public Vector2 ItemSize=new Vector2(400,400);
        public Sprite[] ItemSprites;

        public float Offset=10;
        public float ScaleTimesMin=0.5f;
        ...
        private void Change(int symbol)
        {
            ...
            {
                _items[i].SetPosData(_posDatas[_items[i].PosId]);
            }
        }
        ...
        private void CalulateData()
        {
            ...
            itemDatas = itemDatas.OrderBy(u => _posDatas[u.PosId].ScaleTimes).ToList();

            for (int i = 0; i < itemDatas.Count; i++)
            {
                _posDatas[itemDatas[i].PosId].Order = i;
            }
        }
        ...
        private void SetItemData()
        {
            for (int i = 0; i < _posDatas.Count; i++)
            {
                _items[i].SetPosData(_posDatas[i]);
            }
        }
